...
#define SIGMAENGINE_INIT_PUBLIC_KEY_STR                             "TER6Um48qgj6D6Z9hLCSgaonEvLWMvuNU9dqktYDr3LDxmpDqNoi6" // 5JqYBQtcWprxgEnonQeahkABezDvUPBpLmPWuhEaUNyAWZq5w8j
#define SIGMAENGINE_CHAIN_ID                                        (fc::sha256::hash("terran_mainnet")) //(sigmaengine::protocol::chain_id_type())
#define SGT_SYMBOL                                                  (uint64_t(SIGMAENGINE_BLOCKCHAIN_PRECISION_DIGITS) | (uint64_t('T') << 8) | (uint64_t('R') << 16) | (uint64_t('R') << 24) )
#define SIGMAENGINE_ADDRESS_PREFIX                                  "TER"
#define SIGMAENGINE_GENESIS_TIME                                    (fc::time_point_sec(1659312000))
